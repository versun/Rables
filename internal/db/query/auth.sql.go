...
SELECT id, title, description, author, url, time_zone, head_code, custom_css, tool_code, giscus, social_links, setup_completed, created_at, updated_at, article_route_prefix, feed_all_articles FROM settings WHERE id = 1
`
