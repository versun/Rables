...
ActiveRecord::Schema[8.1].define(version: 2026_01_31_230328) do
  ...
  create_table "jekyll_settings", force: :cascade do |t|
    ...
    t.string "redirect_export_format", default: "netlify"
  ...
  create_table "jekyll_sync_records", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["created_at"], name: "index_jekyll_sync_records_on_created_at"
    t.index ["status"], name: "index_jekyll_sync_records_on_status"
    t.index ["sync_type"], name: "index_jekyll_sync_records_on_sync_type"
  end
